;(function () {
  window.rgbKineticSlider = function (options) {
    ...
    options.slideImages = options.hasOwnProperty('slideImages')
      ? options.slideImages
      : []
    options.itemsTitles = options.hasOwnProperty('itemsTitles')
      ? options.itemsTitles
      : []
    options.backgroundDisplacementSprite = options.hasOwnProperty(
      'backgroundDisplacementSprite'
    )
      ? options.backgroundDisplacementSprite
      : ''
    options.cursorDisplacementSprite = options.hasOwnProperty(
      'cursorDisplacementSprite'
    )
      ? options.cursorDisplacementSprite
      : ''
    options.cursorImgEffect = options.hasOwnProperty('cursorImgEffect')
      ? options.cursorImgEffect
      : true
    options.cursorTextEffect = options.hasOwnProperty('cursorTextEffect')
      ? options.cursorTextEffect
      : true
    options.cursorScaleIntensity = options.hasOwnProperty(
      'cursorScaleIntensity'
    )
      ? options.cursorScaleIntensity
      : 0.25
    options.cursorMomentum = options.hasOwnProperty('cursorMomentum')
      ? options.cursorMomentum
      : 0.14
    options.swipe = options.hasOwnProperty('swipe') ? options.swipe : true
    options.swipeDistance = options.hasOwnProperty('swipeDistance')
      ? options.swipeDistance
      : 500
    options.slideTransitionDuration = options.hasOwnProperty(
      'slideTransitionDuration'
    )
      ? options.slideTransitionDuration
      : 1
    options.transitionScaleIntensity = options.hasOwnProperty(
      'transitionScaleIntensity'
    )
      ? options.transitionScaleIntensity
      : 40
    options.transitionScaleAmplitude = options.hasOwnProperty(
      'transitionScaleAmplitude'
    )
      ? options.transitionScaleAmplitude
      : 300
    options.swipeScaleIntensity = options.hasOwnProperty('swipeScaleIntensity')
      ? options.swipeScaleIntensity
      : 0.3
    options.transitionSpriteRotation = options.hasOwnProperty(
      'transitionSpriteRotation'
    )
      ? options.transitionSpriteRotation
      : 0
    options.nav = options.hasOwnProperty('nav') ? options.nav : true
    options.textsRgbEffect = options.hasOwnProperty('textsRgbEffect')
      ? options.textsRgbEffect
      : true
    options.imagesRgbEffect = options.hasOwnProperty('imagesRgbEffect')
      ? options.imagesRgbEffect
      : false
    options.textsSubTitleDisplay = options.hasOwnProperty(
      'textsSubTitleDisplay'
    )
      ? options.textsSubTitleDisplay
      : false
    options.textsDisplay = options.hasOwnProperty('textsDisplay')
      ? options.textsDisplay
      : false
    options.textsTiltEffect = options.hasOwnProperty('textsTiltEffect')
      ? options.textsTiltEffect
      : true
    options.googleFonts = options.hasOwnProperty('googleFonts')
      ? options.googleFonts
      : ['Roboto:400']
    options.buttonMode = options.hasOwnProperty('buttonMode')
      ? options.buttonMode
      : true
    options.textTitleColor = options.hasOwnProperty('textTitleColor')
      ? options.textTitleColor
      : 'white'
    options.textTitleSize = options.hasOwnProperty('textTitleSize')
      ? options.textTitleSize
      : 125
    options.mobileTextTitleSize = options.hasOwnProperty('mobileTextTitleSize')
      ? options.mobileTextTitleSize
      : 45
    options.textTitleLetterspacing = options.hasOwnProperty(
      'textTitleLetterspacing'
    )
      ? options.textTitleLetterspacing
      : 3
    options.textSubTitleColor = options.hasOwnProperty('textSubTitleColor')
      ? options.textSubTitleColor
      : 'white'
    options.textSubTitleSize = options.hasOwnProperty('textSubTitleSize')
      ? options.textSubTitleSize
      : 21
    options.mobileTextSubTitleSize = options.hasOwnProperty(
      'mobileTextSubTitleSize'
    )
      ? options.mobileTextSubTitleSize
      : 14
    options.textSubTitleLetterspacing = options.hasOwnProperty(
      'textSubTitleLetterspacing'
    )
      ? options.textSubTitleLetterspacing
      : 3
    options.textSubTitleOffsetTop = options.hasOwnProperty(
      'textSubTitleOffsetTop'
    )
      ? options.textSubTitleOffsetTop
      : 120
    options.mobileTextSubTitleOffsetTop = options.hasOwnProperty(
      'mobileTextSubTitleOffsetTop'
    )
      ? options.mobileTextSubTitleOffsetTop
      : 40
    options.textsRgbIntensity = options.hasOwnProperty('textsRgbIntensity')
      ? options.textsRgbIntensity
      : 0.09
    options.navTextsRgbIntensity = options.hasOwnProperty(
      'navTextsRgbIntensity'
    )
      ? options.navTextsRgbIntensity
      : 10
    options.imagesRgbIntensity = options.hasOwnProperty('imagesRgbIntensity')
      ? options.imagesRgbIntensity
      : 0.9
    options.navImagesRgbIntensity = options.hasOwnProperty(
      'navImagesRgbIntensity'
    )
      ? options.navImagesRgbIntensity
      : 100
    ...
    const dispSprite = new PIXI.Sprite.from(
      options.backgroundDisplacementSprite
    )
    ...
    function slideTransition(next) {
      ...
      timelineTransition = new TimelineMax({
        ...
        onUpdate: function () {
          ...
          dispSprite.scale.set(
            timelineTransition.progress() * options.transitionScaleIntensity
          )
          ...
          if (is_loaded === true) {
            ...
            if (options.textsRgbEffect == true) {
              ...
              if (timelineTransition.progress() < 0.5) {
                splitRgb.red = [
                  timelineTransition.progress() * options.navTextsRgbIntensity,
                  0,
                ]
                splitRgb.green = [0, 0]
      ...
      if (
        options.textsSubTitleDisplay == true &&
        options.textsDisplay == true &&
        options.itemsTitles.length > 0
      ) {
        timelineTransition
          ...
          .to(
            [slideImages[next], slideTexts[next], slideTextsSub[next]],
            options.slideTransitionDuration,
            {
              alpha: 1,
              ease: Power2.easeOut,
      ...
      // if subtitles inactive and title active
        ...
        options.textsSubTitleDisplay == false &&
        options.textsDisplay == true &&
        options.itemsTitles.length > 0
      ) {
        timelineTransition
          ...
          .to(
            [slideImages[currentIndex], slideTexts[currentIndex]],
            options.slideTransitionDuration,
            {
              alpha: 0,
              ease: Power2.easeOut,
          ...
          .to(
            [slideImages[next], slideTexts[next]],
            options.slideTransitionDuration,
            {
              alpha: 1,
              ease: Power2.easeOut,
        ...
        function onDragMove() {
          ...
          if (is_swipping) {
            ...
            if (drag_start.x - newPosition.x > options.swipeDistance) {
              if (
                currentIndex > 0 &&
                currentIndex < options.slideImages.length
              ) {
                slideTransition(currentIndex - 1)
              } else {
